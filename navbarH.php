...
<label>
  ...
  <div class="slide">
    ...
    <ul>
      ...
      <li><a class="burguer" href="calendario/index.php"><i class="far fa-comments"></i>Cronograma</a></li>
      <li><a class="burguer" href="anotacao/anotacao.php"><i class="far fa-folder"></i>Anotação</a></li>
